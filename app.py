...
color_Nx_size='#8B4513' # цвет для выделения N-кратного значения
...
def main():
    ...
    fig_posts = create_fig_posts_inds(posts, selected_channel, bgcolor, word_color, contr_color, color_Nx_size) #
