...
def create_fig_subs_inds(subs, selected_channel):
   ...
   # fig_subs.add_trace(go.Bar(x=subdf_subs.date, y=subdf_subs.subs_cnt, marker_color=colors,
    ...
    fig_subs.add_trace(go.Bar(x=subdf_subs.date, y=subdf_subs.subs_cnt, fill='tozeroy', mode='lines+markers', line_color='#F5DEB3', marker_color='#f5dfbf', marker_line_color='#f5dfbf', marker_line_width=1,  marker_size=5,
                              hovertemplate='%{x} <br>Подписчиков: %{y}<extra></extra>'), row=1, col=1)
